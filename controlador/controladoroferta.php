...
if(isset($_POST['insertar']))
{
    ...
    $insert= $ofe->Insertarofe($ofeid,$ofeentidad,$ofenombre,$ofedescripcion,$ofesalario,$ofeidnivel,$ofeidcategoria,$ofeexperiencia,$ofefecha);
...
require_once('vista/vistaOferta.php');
?>