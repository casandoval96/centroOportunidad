...
<div class="col-4">
      ...
      <th><h6>Identificacion</h6><input type="number" class="btn-dark form-control" name="psiide" ></th>
      <td><h6>Nombre</h6><input type="text" class="btn-dark form-control"  name="psinombre" ></td>
      <td><h6>Apellido</h6><input type="text" class="btn-dark form-control"  name="psiapellido" ></td>
      <td><input type="submit" name="insertar" value="Registar"></td>
      </form>
</div>
...
<table class="table table-hover table-secondary col-8" >
 ...
 <?php foreach($datos as $f) { ?> 
  <tbody class="">
    <tr>
      <form action="" method= "POST">
      <th scope="row"><input type="number" class="btn form-control" name="psiide" value="<?php echo $f[0];?>"></th>
      <td><input type="text" class="btn form-control"  name="psinombre" value="<?php echo $f[1];?>"></td>
      <td><input type="text" class="btn form-control"  name="psiapellido" value="<?php echo $f[2];?>"></td>
