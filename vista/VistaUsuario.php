...
<body>
   ...
   <nav class="topnav navbar navbar-dark " style="background-color:#111;" > 
    ...
    <nav class="navbar navbar-expand-lg navbar-light col" style="background-color:rgba(00,00,00,0.3);" >
    <div class="btn-group btn-group-justified" role="group" style="width: 100%;height: 40px;">
      <a href="hojadevida.php" type="button" class="btn btn-secondary  col-12 col-sm-6  col-md-8 col-lg-4 col-xL-8">Hoja de vida</a>
      <a href="oferta2.php" type="button" class="btn btn-secondary col-12 col-sm-6  col-md-8 col-lg-4 col-xL-8">Buscar ofertas</a>
      <a href="aplicaciones.php" type="button" class="btn btn-secondary col-12 col-sm-6  col-md-8 col-lg-4 col-xL-8">Aplicaciones</a>
      <a href="aspirante.php" type="button" class="btn btn-secondary  col-12 col-sm-6  col-md-8 col-lg-4 col-xL-8">Aspirante</a>
